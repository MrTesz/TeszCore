...
public class MariaDBManager extends AbstractMariaDBManager implements SyncDBManager, Copyable<MariaDBManager> {
    ...
    public void createOrAlter(@NotNull DBTable dbTable) throws IllegalArgumentException {
        if (!(dbTable instanceof de.mrtesz.teszcore.utils.db.manager.mariadb.MariaDBTable mariaDBTable)) throw new IllegalArgumentException("DBTable object was not " + de.mrtesz.teszcore.utils.db.manager.mariadb.MariaDBTable.class.getName() + " but " + dbTable.getClass().getName() + ".");
