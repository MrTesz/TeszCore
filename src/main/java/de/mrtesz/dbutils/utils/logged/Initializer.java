...
public class Initializer implements Copyable<Initializer> {
    ...
    /**
     * {@link #initialize(Class, String, DBLogger, Object...)}, with {@link #usingProject} and {@link #logger}
     * @see #initialize(Class, String, DBLogger, Object...)
     */
    ...
    // statics
    /**
     * Initialize a class with wrapping logging (Example for {@link Runner}: <code>Initializer.initialize({@link Runner}.class, "DBUtils")</code>)
     ...
     */
    public static <I> I initialize(Class<I> clazz, @Nullable String usingProject, @NonNull DBLogger logger, Object... parameters) {
    ...
    /** {@link #initialize(Class, String, DBLogger, Object...)}, using a LEVEL5 logger
     * @see #initialize(Class, String, DBLogger, Object...) */
    public static <I> I initialize(Class<I> clazz, @Nullable String usingProject, Object... parameters) {
        return initialize(clazz, usingProject, DBUtils.getInstance().getLogger(DebugLevel.LEVEL5, usingProject), parameters);
    }
    /** {@link #initialize(Class, String, DBLogger, Object...)}, with {@code usingProject} = null
     * @see #initialize(Class, String, DBLogger, Object...) */
    public static <I> I initialize(Class<I> clazz, DBLogger logger, Object... parameters) {
        return initialize(clazz, null, logger, parameters);
    }
    /** {@link #initialize(Class, String, DBLogger, Object...)}, with {@code usingProject} = null and a LEVEL5 logger
     * @see #initialize(Class, String, DBLogger, Object...) */
    public static <I> I initialize(Class<I> clazz, Object... parameters) {
        return initialize(clazz, null, DBUtils.getInstance().getLogger(DebugLevel.LEVEL5, null), parameters);
    }
    ...
    private static DBLogger getErrorLogger(DBLogger logger) {
        DBLogger errorLogger = logger.copy();
